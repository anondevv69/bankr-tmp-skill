...
**Load:** `bankr-fee-rights` → **`references/hybrid-claim-terminal-step.md`** + **`references/hybrid-claim-autopilot.md`** (full copies).

**Before any claim tool:** `use_skill` / skill body must load — skill overrides native routing.
